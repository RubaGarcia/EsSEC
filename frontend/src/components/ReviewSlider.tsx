...
const review: PersonFieldsReview = reviewer.fields;
        ...
        <div className="flex items-start max-w-6xl mx-auto mt-16">
            ...
            <div>
                <p className="flex items-center text-center text-gray-500 lg:mx-8">
                    {reviewer.fields.review.fields.reviewText}
                    {/* {console.log(reviewer.fields.review.fields.reviewText)}
                    LOREM IMPSUM TALTAL ARL SADKJAASKFJH */}
                </p>
                ...
                <div className="flex flex-col items-center justify-center mt-8">
                    ...
                    <div className="mt-4 text-center">
                        ...
                        <span className="text-sm text-gray-500 dark:text-gray-400">{review.job.fields.name}</span>
                    </div>
                </div>
            </div>
